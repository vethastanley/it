...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './app.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APP_LIST actions', async () => {
    ...
    it('dispatches FETCH_APP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APP actions', async () => {
      const expectedActions = [
        {
