...
import { getEntity, deleteEntity } from './app.reducer';
...
export const AppDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(appEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="itApp.app.delete.question">Are you sure you want to delete App {appEntity.id}?</ModalBody>
      <ModalFooter>
